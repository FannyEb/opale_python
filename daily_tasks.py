    ...
    def display_tasks(self):
        ...
        for date_str in sorted(tasks_by_date.keys(), reverse=True):
            ...
            for task in tasks_by_date[date_str]:
                ...
                # Titre cliquable avec style
                title_label = ctk.CTkLabel(self.scroll_frame, text=task.get("title", ""), text_color="#2e6de3", cursor="hand2")
                ...
                # Boutons liens JIRA & SPEC
                col = 2
                if task.get("linkJira"):
